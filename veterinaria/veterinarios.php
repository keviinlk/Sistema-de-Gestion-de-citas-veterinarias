...
<div class="panel panel-default">
    <div class="panel-heading">LISTA DE VETERINARIOS</div>
		...
		<table class="table table-striped table-hover">
			...
			<tbody>
				<?php
				     ...
				     $result=mysqli_query($conexion,'SELECT nombre FROM usuarios where tipo="veterinario"');
    ...
    <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form role="form"  id= "frmveterinario" name="frmveterinario" onsubmit="Registrarveterinario(); return false">
              <div class="col-lg-12">               
